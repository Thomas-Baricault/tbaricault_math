...
namespace tbaricault::uniconvert
{
    ...
    /**
     * @brief Utils class to convert a string to rectangle
     * 
     * @tparam T Rectangle components type
     */
    template<typename T>
    struct Converter<std::string, tbaricault::math::Rect<T>>
    {

        /**
         * @brief Converts a string to rectangle
         * 
         ...
         */
        tbaricault::math::Rect<T> operator()(const std::string& value) const;

    };


    /**
     * @brief Utils class to convert a rectangle to string
     * 
     * @tparam T Rectangle components type
     */
    template<typename T>
    struct Converter<tbaricault::math::Rect<T>, std::string>
    {

        /**
         * @brief Converts a rectangle to its string representation
         * 
         * @param value Rectangle to convert
         * 
         * @return String representation
         */
        std::string operator()(const tbaricault::math::Rect<T>& value) const;
